    ...
    def use_native_orbitals(self, inplace=False, core: list = None, *args, **kwargs):
        ...
        if len(core):
            ...
            if inplace:
                ...
                select={active.index(i):self.select[i] for i in active}, two_qubit=self.two_qubit, condense=self.condense
                                                    ,integral_tresh=self.integral_tresh,active_orbitals=[*to_active.values()])
                return result
        ...
        if inplace:
            ...
            parameters = copy.deepcopy(self.parameters)
            result = QuantumChemistryHybridBase(parameters=parameters, integral_manager=integral_manager,
            transformation=self.transformation,select=self.select, two_qubit=self.two_qubit, condense=self.condense,
